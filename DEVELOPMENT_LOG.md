...
### Следующие шаги:
1. ✅ Настроить Google Cloud Project (OAuth Client ID)
2. ✅ Создать иконки для расширения
3. ✅ Загрузить в Chrome и протестировать базовую функциональность
4. ⏭️ Протестировать PDF парсинг
5. ⏭️ Протестировать экспорт в Excel/CSV
6. ⏭️ Настроить Google Sheets интеграцию
